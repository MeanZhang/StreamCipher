...
public class ZUC128 {
    ...
    public static void main(String[] args) {
        ...
        //每两个字符转为一字节密钥
        for (int i = 0; i < 16; i++)
            k[i] = Integer.parseInt(String.valueOf(a, 2 * i, 2), 16);
        System.out.println("iv:");
        a = scan.next().toCharArray();
        //每两个字符转为一字节初始向量
        for (int i = 0; i < 16; i++)
            iv[i] = Integer.parseInt(String.valueOf(a, 2 * i, 2), 16);
        //生成的密钥数量
        System.out.print("length: ");
        length = scan.nextInt();
        ZUC128 zuc = new ZUC128(k, iv);
